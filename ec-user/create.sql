create table tb_role (id bigint generated by default as identity, role varchar(255), primary key (id));
create table tb_user (id bigint generated by default as identity, address varchar(255), email varchar(255) unique, name varchar(255), password varchar(255), phone varchar(255) unique, primary key (id));
